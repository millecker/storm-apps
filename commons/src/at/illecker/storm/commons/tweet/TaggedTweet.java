...
public final class TaggedTweet implements Serializable {
  private static final long serialVersionUID = 4981779725843228602L;
  private final Tweet m_tweet;
  private final List<List<TaggedWord>> m_taggedSentences;

  public TaggedTweet(Long id, String text, Double score,
      List<List<TaggedWord>> taggedSentences) {
    this.m_tweet = new Tweet(id, text, score);
    this.m_taggedSentences = taggedSentences;
  }
