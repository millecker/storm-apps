...
public class WordNet {
  ...
  public void testDictionary() throws IOException, InterruptedException {
    ...
    IIndexWord idxWord = m_dict.getIndexWord("dog", POS.NOUN);
  ...
  public static void main(String[] args) {
    try {
      WordNet.getInstance().testDictionary();
